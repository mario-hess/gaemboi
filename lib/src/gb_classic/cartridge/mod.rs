...
use crate::gb_classic::cartridge::{
    core::CartridgeCore, mbc0::Mbc0, mbc1::Mbc1, mbc2::Mbc2, mbc3::Mbc3, mbc5::Mbc5,
};
...
impl Cartridge {
    pub fn build(rom_data: &Vec<u8>) -> Result<Self, String> {
        ...
        let mbc: Box<dyn MemoryBankController> = match rom_data[CARTRIDGE_TYPE_ADDRESS] {
            ...
            _ => return Err("Error: Cartridge type not supported".to_string()),
        };
