...
impl Instruction {
    ...
    pub fn from_byte(value: u8) -> Self {
        match value {
            ...
            0x01 => Instruction::new(Mnemonic::LDPairNN(Target::BC), 3, 3),
            0x02 => Instruction::new(Mnemonic::LDPairReg(Target::BC, Target::A), 1, 2),
            0x03 => Instruction::new(Mnemonic::INCPair(Target::BC), 1, 2),
            0x04 => Instruction::new(Mnemonic::INCReg(Target::B), 1, 1),
            0x0B => Instruction::new(Mnemonic::DECPair(Target::BC), 1, 2),
            ...
            0x26 => Instruction::new(Mnemonic::LDRegN(Target::H), 2, 2),
            0x28 => Instruction::new(Mnemonic::JRce(Flag::Z), 2, 2),
            0x2A => Instruction::new(Mnemonic::LDaHLp, 1, 2),
            0x2E => Instruction::new(Mnemonic::LDRegN(Target::L), 2, 2),
            0x30 => Instruction::new(Mnemonic::JRnce(Flag::C), 2, 3),
            0x31 => Instruction::new(Mnemonic::LDSPnn, 3, 3),
            ...
            0x80 => Instruction::new(Mnemonic::AddReg(Target::B), 1, 1),
            ...
            0xB1 => Instruction::new(Mnemonic::ORReg(Target::C), 1, 1),
            0xC0 => Instruction::new(Mnemonic::Retnc(Flag::Z), 1, 2),
            0xC1 => Instruction::new(Mnemonic::POPPair(Target::BC), 1, 3),
            0xC3 => Instruction::new(Mnemonic::JPnn, 3, 4),
            0xC4 => Instruction::new(Mnemonic::CALLNFnn(Flag::Z), 3, 3),
            0xC5 => Instruction::new(Mnemonic::PushPair(Target::BC), 1, 4),
            0xC8 => Instruction::new(Mnemonic::Retc(Flag::Z), 1, 2),
            0xC9 => Instruction::new(Mnemonic::Ret, 1, 4),
            0xCB => Instruction::new(Mnemonic::Prefix, 1, 1),
            0xCC => Instruction::new(Mnemonic::CALLFnn(Flag::Z), 3, 3),
            0xCD => Instruction::new(Mnemonic::CALLnn, 3, 6),
            0xCF => Instruction::new(Mnemonic::Rst(0x0008), 1, 4),
            0xD6 => Instruction::new(Mnemonic::Subn, 2, 2),
            0xDF => Instruction::new(Mnemonic::Rst(0x0018), 1, 4),
            0xE0 => Instruction::new(Mnemonic::LDHnA, 2, 3),
            0xE1 => Instruction::new(Mnemonic::POPPair(Target::HL), 1, 3),
            0xE5 => Instruction::new(Mnemonic::PushPair(Target::HL), 1, 4),
            0xE6 => Instruction::new(Mnemonic::ANDn, 2, 2),
            ...
            0xF1 => Instruction::new(Mnemonic::POPaf, 1, 3),
            0xF3 => Instruction::new(Mnemonic::DisableInterrupt, 1, 1),
            0xF5 => Instruction::new(Mnemonic::PushPair(Target::AF), 1, 4),
            0xF9 => Instruction::new(Mnemonic::LDSPhl, 1, 2),
            0xFA => Instruction::new(Mnemonic::LDaNN, 3, 4),
